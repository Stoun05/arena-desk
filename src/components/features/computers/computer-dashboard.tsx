  ...
  return (
    <div className="flex flex-col gap-7">
      <section className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        <div>
          <p className="text-sm font-medium text-indigo-300">Esasy panel · Stage 13</p>
      ...
      <section aria-label="Server ýagdaýy" className="grid gap-4 rounded-2xl border border-white/10 bg-white/[0.025] p-4 sm:grid-cols-2 sm:p-5 xl:grid-cols-4">
        ...
        <div className="flex items-center gap-3 sm:justify-center">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-sky-300">Player Screen · Janly timer</p>
          </div>
        </div>
        <div className="flex items-center gap-3 sm:justify-end">
          ...
          <div className="sm:text-right">
            ...
            <p className="mt-1 text-xs text-emerald-300">7 tablisa · Stage 13 işleýär</p>
          </div>
        </div>
      </section>
